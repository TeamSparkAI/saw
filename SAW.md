...
> ```
> Implement the spec, including unit tests. Do not stop until the spec
> is fully implemented. Flag any issues or changes from the spec in your
...
>
> You must narrow unknown variables using type guards or property checks before accessing them.
> ```
